This directory contains subdirectories for my miniproject on the functional response 
dataset. In the Code subdirectory are all the Rscripts that will output results to the 
Results and Data subdirectories. To run the project and generate the report enter the 
following command in a terminal from the Code directory:

	bash compiler.sh

We will now specify what each file does and what the dependencies are:
